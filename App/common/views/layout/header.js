(function () {
    appModule.controller('common.views.layout.header', [
        '$rootScope', '$scope', '$stateParams', '$uibModal', 'appSession', 'appUserNotificationHelper', 'abp.services.app.notification', 'abp.services.app.userLink',
        function ($rootScope, $scope, $stateParams, $uibModal, appSession, appUserNotificationHelper, notificationService, userLinkService) {
            var vm = this;
            ...
            vm.changeProfile = function () {
                $uibModal.open({
                    templateUrl: '~/App/common/views/profile/changeProfile.cshtml',
                    controller: 'common.views.profile.changeProfile as vm',
                    backdrop: 'static'
                });
            };
