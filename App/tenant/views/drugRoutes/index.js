(function () {
    appModule.controller('tenant.views.drugRoutes.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.drugRoute',
        function ($scope, $uibModal, $stateParams, uiGridConstants, drugRouteService) {
            var vm = this;
            vm.loading = false;
            ...
            vm.activateSelectedDrugRoute = function () {
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            drugRouteService.activateSelectedDrugRoute(
                                datalist
                            ).then(function () {
                                vm.getDrugRoutes();
            ...
            vm.deactivateSelectedDrugRoute = function () {
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            drugRouteService.deactivateSelectedDrugRoute(
                                datalist
                            ).then(function () {
                                vm.getDrugRoutes();
            ...
            vm.deleteSelectedDrugRoute = function () {
                if ($scope.gridApi.selection.getSelectedRows().length == 0) {
                    abp.message.info(app.localize('PromptSelectRecord'));
                    return;
                }
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            drugRouteService.deleteSelectedDrugRoute(
                                deletelist
                            ).then(function () {
                                vm.getDrugRoutes();
            ...
            vm.createDrugRoute = function () {
                openCreateOrEditModal(null);
            };

            vm.rowDblClick = function (row) {
                vm.editDrugRoute(row.entity.id);
            };

            vm.editDrugRoute = function (id) {
                openCreateOrEditModal(id);
            };

            function openCreateOrEditModal(id, action) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/tenant/views/drugRoutes/createOrEditDrugRoute.cshtml',
                    controller: 'tenant.views.drugRoutes.createOrEditDrugRoute as vm',
                    backdrop: 'static',
                    resolve: {
                        id: function () {
                            return id;
            ...
            vm.getDrugRoutes = function () {
                vm.loading = true;

                drugRouteService.getAllDrugRoutes(
