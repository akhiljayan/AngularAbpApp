(function () {
    appModule.controller('tenant.views.referral.index', [
        '$scope', '$timeout', 'abp.services.app.referral', '$location', '$anchorScroll', '$filter',
    function ($scope, $timeout, referralService, $location, $anchorScroll, $filter) {
        //Variables
        var vm = this;
        vm.filter = null;
        vm.persons = [];
