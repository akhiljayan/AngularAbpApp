(function () {
    appModule.controller('tenant.views.referral.createOrEditReferralServiceType', [
        '$scope', '$timeout', '$uibModal', '$uibModalInstance', 'abp.services.app.masterLookUp', 'referralServiceTypeId', 'action', 'referral','status', 'abp.services.app.referral', 'abp.services.app.serviceType',
        function ($scope, $timeout, $uibModal, $uibModalInstance, masterLookup, referralServiceTypeId, action, referral,status, appReferralService, serviceType) {
            var vm = this;
            ...
            vm.save = function () {
                vm.saving = true;
                if ($scope.isEmptyGuid(referralServiceTypeId)) {
