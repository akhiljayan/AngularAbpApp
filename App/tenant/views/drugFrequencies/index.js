(function () {
    appModule.controller('tenant.views.drugFrequencies.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.drugFrequency',
        function ($scope, $uibModal, $stateParams, uiGridConstants, drugFrequencyService) {
            var vm = this;
            vm.loading = false;
            ...
            vm.activateSelectedDrugFrequency = function () {
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            drugFrequencyService.activateSelectedDrugFrequency(
                                datalist
                            ).then(function () {
                                vm.getDrugFrequencies();
            ...
            vm.deactivateSelectedDrugFrequency = function () {
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            drugFrequencyService.deactivateSelectedDrugFrequency(
                                datalist
                            ).then(function () {
                                vm.getDrugFrequencies();
            ...
            vm.deleteSelectedDrugFrequency = function () {
                if ($scope.gridApi.selection.getSelectedRows().length == 0) {
                    abp.message.info(app.localize('PromptSelectRecord'));
                    return;
                }
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            drugFrequencyService.deleteSelectedDrugFrequency(
                                deletelist
                            ).then(function () {
                                vm.getDrugFrequencies();
            ...
            vm.createDrugFrequency = function () {
                openCreateOrEditModal(null);
            };

            vm.rowDblClick = function (row) {
                vm.editDrugFrequency(row.entity.id);
            };

            vm.editDrugFrequency = function (id) {
                openCreateOrEditModal(id);
            };

            function openCreateOrEditModal(id, action) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/tenant/views/drugFrequencies/createOrEditDrugFrequency.cshtml',
                    controller: 'tenant.views.drugFrequencies.createOrEditDrugFrequency as vm',
                    backdrop: 'static',
                    resolve: {
                        id: function () {
                            return id;
            ...
            vm.getDrugFrequencies = function () {
                vm.loading = true;

                drugFrequencyService.getAllDrugFrequencies(
