(function () {
    appModule.controller('tenant.views.visitTypes.index', [
        '$scope', '$uibModal', '$stateParams', 'uiGridConstants', 'abp.services.app.visitType',
        function ($scope, $uibModal, $stateParams, uiGridConstants, visitTypeService) {
            var vm = this;
            vm.loading = false;
            ...
            vm.gridOptions = {
                ...
                columnDefs: [
                    ...
                    {
                        name: app.localize('VisitTypeCode'),
                        field: 'code',
                        enableHiding: false,
                        enableCellEdit: false,
                        enableColumnMenu: false,
                    ...
                    {
                        name: app.localize('VisitTypeDescription'),
                        field: 'description',
                        enableHiding: false,
                        enableCellEdit: false,
                        enableColumnMenu: false,
            ...
            vm.activateSelectedVisitType = function () {
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            visitTypeService.activateSelectedVisitType(
                                datalist
                            ).then(function () {
                                vm.getVisitTypes();
            ...
            vm.deactivateSelectedVisitType = function () {
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            visitTypeService.deactivateSelectedVisitType(
                                datalist
                            ).then(function () {
                                vm.getVisitTypes();
            ...
            vm.deleteSelectedVisitType = function () {
                if ($scope.gridApi.selection.getSelectedRows().length == 0) {
                    abp.message.info(app.localize('PromptSelectRecord'));
                    return;
                }
                ...
                abp.message.confirm(
                    ...
                    function (isConfirmed) {
                        if (isConfirmed) {
                            ...
                            visitTypeService.deleteSelectedVisitType(
                                deletelist
                            ).then(function () {
                                vm.getVisitTypes();
            ...
            vm.createVisitType = function () {
                openCreateOrEditModal(null);
            };

            vm.rowDblClick = function (row) {
                vm.editVisitType(row.entity.id);
            };

            vm.editVisitType = function (id) {
                openCreateOrEditModal(id);
            };

            function openCreateOrEditModal(id, action) {
                var modalInstance = $uibModal.open({
                    templateUrl: '~/App/tenant/views/visitTypes/createOrEditVisitType.cshtml',
                    controller: 'tenant.views.visitTypes.createOrEditVisitType as vm',
                    backdrop: 'static',
                    resolve: {
                        id: function () {
                            return id;
